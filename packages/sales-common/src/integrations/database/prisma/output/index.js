...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/kvvprof/Работа/unity/sales-monorepo/packages/sales-common/src/integrations/database/prisma/output",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/integrations/database/prisma/output",
    "integrations/database/prisma/output",
  ]
...
path.join(process.cwd(), "src/integrations/database/prisma/output/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-arm64-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/integrations/database/prisma/output/libquery_engine-linux-arm64-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/integrations/database/prisma/output/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/integrations/database/prisma/output/schema.prisma")
