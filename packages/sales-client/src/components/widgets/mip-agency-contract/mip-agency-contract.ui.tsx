...
} from '@/components/widgets/mip-agency-contract/mip-agency-contract.gql';
import { IMIPAgencyContract } from '@/components/widgets/mip-agency-contract/mip-agency-contract.interface';
import {
			...
			formik.setValues({
				...
				mip_agency_contract_properties: {
					agency_contract_commission: {
						percent: parseFloat(
							data.getAgencyContract.mip_agency_contract_properties
