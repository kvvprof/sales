...
import { IDDUClientContract } from '@/components/widgets/ddu-client-contract/ddu-client-contract.interface';
import {
		...
		onCompleted(data) {
			formik.setValues({
				...
				ddu_client_contract_properties: {
					ddu_link:
						data.getClientContract.ddu_client_contract_properties?.ddu_link ||
						'',
					escrow_account_number:
						data.getClientContract.ddu_client_contract_properties
							?.escrow_account_number || '',
