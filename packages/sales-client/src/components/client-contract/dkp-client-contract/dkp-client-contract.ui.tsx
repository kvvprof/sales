...
} from '@/components/client-contract/dkp-client-contract/dkp-client-contract.gql';
import { IDkpClientContract } from '@/components/client-contract/dkp-client-contract/dkp-client-contract.interface';
import {
  DkpClientContractSchema,
  initialValues,
  validationSchema,
} from '@/components/client-contract/dkp-client-contract/dkp-client-contract.validation';
...
export const DkpClientContract = ({ id }: IDkpClientContract) => {
    ...
    onCompleted(data) {
      formik.setValues({
        ...
        dkpClientContractProperties: {
          dkpLink:
            data.getClientContract.dkpClientContractProperties?.dkpLink || '',
        },
      });
      ...
      updateClientContract({
        variables: {
          input: normalizePayload({
            ...
            dkpClientContractProperties: data.dkpClientContractProperties,
          }),
        },
      });
    },
  ...
  const handleCopyClientContract = () => {
    setClientContract({
      ...
      dduClientContractProperties: null,
      dkpClientContractProperties: formik.values.dkpClientContractProperties,
    });
    navigate('/client-contract/dkp/new');
  };
            ...
            <Form>
              ...
              <NamedGroup title='Дополнительные данные'>
                <Input
                  ...
                  name='dkpClientContractProperties.dkpLink'
                  value={formik.values.dkpClientContractProperties.dkpLink}
                  error={
                    formik.touched.dkpClientContractProperties?.dkpLink
                      ? formik.errors.dkpClientContractProperties?.dkpLink
                      : null
                  }
                  linkTo={formik.values.dkpClientContractProperties.dkpLink}
                  onChange={formik.handleChange}
                />
                <Input
