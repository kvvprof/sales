...
import { CREATE_CLIENT_CONTRACT } from '@/components/client-contract/dkp-client-contract/dkp-client-contract.gql';
import {
...
export const NewDkpClientContract = () => {
  ...
  const [createClientContract, { loading: createClientContractLoading }] =
    useMutation(CREATE_CLIENT_CONTRACT, {
      onCompleted(data) {
        navigate(`/client-contract/dkp/${data.createClientContract.id}`);
        ...
        variables: {
          input: normalizePayload({
            clientContractProperties: {
              ...
              clientContractType: ClientContractType.Dkp,
            },
  ...
  useEffect(() => {
    if (clientContract && clientContract.dkpClientContractProperties) {
      formik.setValues({
        clientContractProperties: clientContract.clientContractProperties,
        dkpClientContractProperties: clientContract.dkpClientContractProperties,
      });
