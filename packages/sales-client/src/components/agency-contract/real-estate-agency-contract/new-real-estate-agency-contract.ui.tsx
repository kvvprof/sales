...
import { CREATE_AGENCY_CONTRACT } from '@/components/agency-contract/real-estate-agency-contract/real-estate-agency-contract.gql';
import {
  initialValues,
...
export const NewRealEstateAgencyContract = () => {
  ...
  const handleDefaultCommissionValues = () => {
    formik.setFieldValue(
      'realEstateAgencyContractProperties.agencyContractCommission.percent',
      3,
    );
    formik.setFieldValue(
      'realEstateAgencyContractProperties.agencyContractCommission.threshold',
      30,
    );
    formik.setFieldValue(
      'realEstateAgencyContractProperties.agencyContractCommission.maxDays',
      5,
    );
  };
